...
@Component({
  selector: 'ngx-edit-yarn-dyeing-wowithout-order-details',
  templateUrl: './edit-yarn-dyeing-wowithout-order-details.component.html',
  styleUrls: ['./edit-yarn-dyeing-wowithout-order-details.component.scss']
})
export class EditYarnDyeingWOWithoutOrderDetailsComponent implements OnInit {
 ...
 this.yarnDyeingWOWithoutOrderDetailService.yarnDyeingWOWithoutOrderDetail=items;
  });
...
this.yarnDyeingWOWithoutOrderDetailService.yarnDyeingWOWithoutOrderDetail.entryDate=this.dateResizeService.dateResize(new Date);
  this.yarnDyeingWOWithoutOrderDetailService.update(this.yarnDyeingWOWithoutOrderDetailService.yarnDyeingWOWithoutOrderDetail).subscribe(res=>{
    console.log(res);       
