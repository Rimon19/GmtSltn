...
@Component({
  selector: 'ngx-edit-sample-fabric-booking-withoutorder-masters',
  templateUrl: './edit-sample-fabric-booking-withoutorder-masters.component.html',
  styleUrls: ['./edit-sample-fabric-booking-withoutorder-masters.component.scss']
})
export class EditSampleFabricBookingWithoutorderMastersComponent implements OnInit {
  ...
  this.sampleFabricBookingWithoutOrderMasterService.getAll().subscribe(data=>{
 let items=  data.find(f=>f.id==this.editedId);
 this.sampleFabricBookingWithoutOrderMasterService.sampleFabricBookingWithoutOrderMaster=items;
  });
...
this.sampleFabricBookingWithoutOrderMasterService.sampleFabricBookingWithoutOrderMaster.deliveryDate=this.dateResizeService.dateResize( this.sampleFabricBookingWithoutOrderMasterService.sampleFabricBookingWithoutOrderMaster.deliveryDate);
  ...
  this.sampleFabricBookingWithoutOrderMasterService.update(this.sampleFabricBookingWithoutOrderMasterService.sampleFabricBookingWithoutOrderMaster).subscribe(res=>{
    console.log(res);       
