...
@Component({
  selector: 'ngx-add-short-trims-booking',
  templateUrl: './add-short-trims-booking.component.html',
  styleUrls: ['./add-short-trims-booking.component.scss']
})
export class AddShortTrimsBookingComponent implements OnInit {
  Tostr = new Tostr();
  ...
  jobNumberDDL() {
    ...
    onSubmit(){
      ...
      this.shortTrimsBookingService.addShortTrimsBooking(this.shortTrimsBookingService.shortTrimsBooking).subscribe(data=>{
