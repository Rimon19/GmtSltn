...
@Component({
  selector: 'ngx-add-service-booking-for-kniting',
  templateUrl: './add-service-booking-for-kniting.component.html',
  styleUrls: ['./add-service-booking-for-kniting.component.scss']
})
export class AddServiceBookingForKnitingComponent implements OnInit {
  Tostr=new Tostr();
...
this.serviceBookingForKnitingandDyeingWithoutOrderService.serviceBookingForKnitingandDyeingWithoutOrder.entryDate=this.dateResizeService.dateResize(new Date);
  this.serviceBookingForKnitingandDyeingWithoutOrderService.add(this.serviceBookingForKnitingandDyeingWithoutOrderService.serviceBookingForKnitingandDyeingWithoutOrder).subscribe(res=>{
    console.log(res);       
