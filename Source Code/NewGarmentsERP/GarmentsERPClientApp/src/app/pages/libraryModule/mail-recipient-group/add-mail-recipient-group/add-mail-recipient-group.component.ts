...
@Component({
  ...
  templateUrl: './add-mail-recipient-group.component.html',
  styleUrls: ['./add-mail-recipient-group.component.scss']
})
export class AddMailRecipientGroupComponent implements OnInit {
  ...
  companyname: any = [
    ...
    onSubmit(form:NgForm){
      this.mailRecipientGroupService.addMailRecipientGroup(form.value).subscribe(res=>{
