...
@Component({
  selector: 'ngx-add-buyer-profile',
  templateUrl: './add-buyer-profile.component.html',
  styleUrls: ['./add-buyer-profile.component.scss']
})
export class AddBuyerProfileComponent implements OnInit {
...
console.log(form.value);
    ...
    this.buyerProfileService.add(form.value).subscribe(res=>{
       console.log(res);       
