...
@Component({
  selector: 'ngx-edit-trims-costing-template',
  templateUrl: './edit-trims-costing-template.component.html',
  styleUrls: ['./edit-trims-costing-template.component.scss']
})
export class EditTrimsCostingTemplateComponent implements OnInit {
  ...
  private route:ActivatedRoute
     ...
     this.trimsCostingTemplateService.trimsCostingTemplate=items;
      });
     }
...
supplierDDL(){
  this.supplierProfileService.getAll().subscribe(data=>{
   ...
   onSubmit(form:NgForm){
    ...
    this.trimsCostingTemplateService.update(form.value).subscribe(res=>{
       console.log(res);       
