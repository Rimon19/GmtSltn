...
@Component({
  selector: 'ngx-add-dyeing-and-finishing-charge',
  templateUrl: './add-dyeing-and-finishing-charge.component.html',
  styleUrls: ['./add-dyeing-and-finishing-charge.component.scss']
})
export class AddDyeingAndFinishingChargeComponent implements OnInit {
  orderUOM:any[] = [];
  Tostr=new Tostr()
  constructor(
...
onSubmit(form:NgForm){
  this.dyeingAndFinishingChargeService.addDyeingAndFinishingCharge(form.value).subscribe(res=>{
