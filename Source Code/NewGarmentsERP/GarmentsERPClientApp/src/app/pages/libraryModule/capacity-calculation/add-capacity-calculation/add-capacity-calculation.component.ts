...
import { LocationComponent } from '../../../merchandizer-module/location/location.component';
...
@Component({
  selector: 'ngx-add-capacity-calculation',
  templateUrl: './add-capacity-calculation.component.html',
  styleUrls: ['./add-capacity-calculation.component.scss']
})
export class AddCapacityCalculationComponent implements OnInit {
