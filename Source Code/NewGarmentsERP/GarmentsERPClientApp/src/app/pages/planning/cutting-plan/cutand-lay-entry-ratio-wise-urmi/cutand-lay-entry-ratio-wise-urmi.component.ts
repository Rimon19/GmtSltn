...
@Component({
  selector: 'ngx-cutand-lay-entry-ratio-wise-urmi',
  templateUrl: './cutand-lay-entry-ratio-wise-urmi.component.html',
  styleUrls: ['./cutand-lay-entry-ratio-wise-urmi.component.scss']
})
export class CutandLayEntryRatioWiseUrmiComponent implements OnInit {
...
constructor(private CutandLayEntryRatioWiseUrmiService:CutandLayEntryRatioWiseUrmiService,
...
redirectToAddPage(){
  this.router.navigate(["/pages/planning/create-cut-and-lay-entry-ratio-wise-urmi"]);
 
}
redirectToEditPage(element){
  this.router.navigate(["/pages/planning/edit-cut-and-lay-entry-ratio-wise-urmi",element.id]);  
}
...
onDelete(element){
  ...
  this.mathdialogService.openConfirmDialog('Are you sure to delete this record ?')
             .afterClosed().subscribe(res=>{
              if(res){
                this.CutandLayEntryRatioWiseUrmiService.delete(element.id).subscribe(res=>{
                  this.refresList();
...
refresList(){    
  this.CutandLayEntryRatioWiseUrmiService.getAll().subscribe(items=>{
