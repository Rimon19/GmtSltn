...
@Component({
  selector: 'ngx-cutand-lay-entry-roll-wise',
  templateUrl: './cutand-lay-entry-roll-wise.component.html',
  styleUrls: ['./cutand-lay-entry-roll-wise.component.scss']
})
export class CutandLayEntryRollWiseComponent implements OnInit {
...
constructor(private cutandLayEntryRollWiseService:CutandLayEntryRollWiseService,
...
redirectToAddPage(){
  this.router.navigate(["/pages/planning/create-cut-and-lay-entry-roll-wise"]);
 
}
redirectToEditPage(element){
  this.router.navigate(["/pages/planning/edit-cut-and-lay-entry-roll-wise",element.id]);  
}
...
onDelete(element){
  ...
  this.mathdialogService.openConfirmDialog('Are you sure to delete this record ?')
             .afterClosed().subscribe(res=>{
              if(res){
                this.cutandLayEntryRollWiseService.delete(element.id).subscribe(res=>{
                  this.refresList();
...
refresList(){    
  this.cutandLayEntryRollWiseService.getAll().subscribe(items=>{
